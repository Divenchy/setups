...
export namespace Gtk4LayerShell {
    ...
    /**
     * @param window A layer surface.
     * @param edge the edge to which the surface may or may not be anchorable
     * @returns if exclusive zone is enabled for the given edge, may or may not actually have an exclusive zone, depending on anchors.
     * @since 1.4
     */
    function get_exclusive_edge_enabled(window: Gtk.Window, edge: Edge): boolean;
     ...
     * 
     * Default is `true` for each {@link Gtk4LayerShell.Edge}
     * @param window A layer surface.
     * @param edge A {@link Gtk4LayerShell.Edge} this layer surface may be anchored to.
     * @param enable Whether or not to to have an exclusive zone on `edge`.
     * @since 1.4
     */
    function set_exclusive_edge_enabled(window: Gtk.Window, edge: Edge, enable: boolean): void;
